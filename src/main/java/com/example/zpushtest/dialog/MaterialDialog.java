package com.example.zpushtest.dialog;
...
import com.example.zpushtest.R;
...
public class MaterialDialog {
    ...
    public MaterialDialog setPositiveButtonText(String text){
        this.pText = text;
        return this;
    }
    ...
    public MaterialDialog setNegativeButtonText(String text){
        this.nText = text;
        return this;
    }
